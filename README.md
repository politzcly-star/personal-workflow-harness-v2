...
5. 记录包管理器、启动命令、测试命令、构建命令、端口、主要目录、禁止修改区域、数据库边界、部署边界、常用验证命令。
...
5. 数据库相关用 `templates/database-checklist.md`。
6. 准备 push/PR/merge/清理分支前用 `templates/branch-finish.md` 和 `scripts/branch-finish-check.ps1`。
7. 完成前用 `templates/verification-report.md` 或同等结构报告。
